...
//        }.ge;
    ...
    @GetMapping(value = {"", "/{id}"})
    @CrossOrigin
    public ResponseEntity get(HttpServletRequest request, @PathVariable(required = false) Long id, @RequestParam(value = "newest", required = false, defaultValue = "false") Boolean newest) throws IOException {
