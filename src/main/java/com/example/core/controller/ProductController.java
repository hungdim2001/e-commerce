...
//        }.getType();
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseObj(HttpStatus.OK.value(), true, "create/update product successfully ", productService.create(id, thumbnail, images, oldImages, productTypeId, name, status, description, productCharValues, variantsObjs, variantImages)));
    }
